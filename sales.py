...
class salesClass:
    def __init__(self,root):
        ...
        txt_invoice=Entry(self.root,textvariable=self.var_invoice,font=("times new roman",15),bg="lightyellow").place(x=160,y=100,width=100,height=28)
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("time new roman",15,"bold"),bg="lightgray",cursor="hand2").place(x=490,y=100,width=120,height=28)
...
#=======Image========
        ...
        self.bill_photo=self.bill_photo.resize((480,300),Image.LANCZOS) 
...
#=================================
    ...
    def show(self):
        ...
        #print(os.listdir('../STOCK')) bill1.txt,category.py
        for i in os.listdir('bill'):
          #print(i.sqlit('.'),i.sqlit('.')[-1]) 
          if i.split('.')[-1]=='txt': 
